...
const CardSearch = ({formattedStartDate, formattedEndDate, formatnombre }) => {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/events/filtered-events?page=${currentPage}&fromDate=${formattedStartDate}&toDate=${formattedEndDate}&searchText=${formatnombre}`)
      .then((response) => {
        if (!response.ok) {
